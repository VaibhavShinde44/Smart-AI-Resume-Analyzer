...
<img src="https://socialify.git.ci/Hunterdii/Smart-AI-Resume-Analyzer/image?custom_description=6th+Sem+Final+Year+Project+at+JaiKranti+College+%282024-2025%29&description=1&font=Bitter&language=1&name=1&pattern=Circuit+Board&stargazers=1&theme=Dark&pattern=Transparent" alt="Smart-AI-Resume-Analyzer" width="1150" />
...
<table align="center">
  ...
  <p>
    <small align="justify">
      ...
      <a href="https://www.linkedin.com/in/het-patel-8b110525a/?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app">Vaibhav Shinde</a>
     </small>
  </p>
...
Open a terminal and run:
   ...
   ```bash
   git clone https://github.com/VaibhavShinde44/Smart-AI-Resume-Analyzer.git
